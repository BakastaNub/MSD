...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,_rgba(234,88,12,0.06)_0%,_transparent_50%)] pointer-events-none" />
      <Navbar />
      <div className="flex-1 flex items-center justify-center px-4 pt-16 relative z-10">
        ...
        >
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-500 text-white px-8 py-4 rounded-xl text-lg font-semibold transition-all shadow-xl shadow-green-600/30"
          >
